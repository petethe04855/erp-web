...
export default function LiveSessionsPage() {
  ...
  const BLANK_SCHEDULE = {
    ...
    status: "scheduled" as ContentScheduleStatus,
    topic: "",
    date: "",
    startTime: "20:00",
    endTime: "22:00",
  ...
  function submitSession() {
    if (formNetMinutes <= 0) {
      setToast("เวลาจบต้องมากกว่าเวลาเริ่ม");
      return;
    }
    if (
      hasLiveOverlap(sessions, {
        staff_id: form.staff_id,
        start_datetime: form.start_datetime,
        end_datetime: form.end_datetime,
      })
    ) {
      setToast("เวลานี้ซ้อนกับ log เดิมของพนักงานคนนี้");
      return;
    }
    addLiveSession({
      ...form,
        ...
        >
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "22px 24px" }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              />
              {scheduleErrors.date && (
                <div style={{ fontSize: 11, color: c.neg, marginTop: 4 }}>
                  {scheduleErrors.date}
                </div>
              )}
            </div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              >
                <div>
                  <div style={{ fontSize: 10, color: c.ink3, marginBottom: 4 }}>
                    เริ่ม
                  </div>
                  <input
                    type="time"
        ...
        >
          {[
            ...
            <div
              key={tile.label}
              style={{
                background: tile.primary ? c.subtle : c.surface,
                border: `1px solid ${c.border}`,
                borderRadius: t.radius,
                padding: "18px 20px",
              }}
                    ...
                    >
                      ...
                      >
                        <StatusPill
                          t={t}
                          status={
                            s.status === "scheduled" ? "shipped" : s.status
                          }
                        />
                      </td>
                      <td
            ...
            .map((s) => (
              <Card t={t} key={s.id}>
                ...
                >
                  ...
                  <StatusPill
                    t={t}
                    status={s.status === "scheduled" ? "shipped" : "draft"}
                  />
                </div>
                <div
                  style={{
            ...
            <thead>
              <tr>
                {[
                  ...
                  <th
                    key={h.l}
                    style={{ ...th, textAlign: h.r ? "right" : "left" }}
                  >
                    {h.l}
                  </th>
                ))}
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    roundingPolicy === item.key ? c.surface : "transparent",
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px" }}>
              ...
              >
                ...
                <div>
                  <label style={lbl}>แพลตฟอร์ม</label>
                  <select
                    value={form.platform}
                    onChange={(e) => {
              ...
              <div style={{ marginBottom: 12 }}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, tiktok_account: e.target.value }))
                  }
                  style={{ ...inp, background: c.subtle }}
                >
              ...
              >
                <div>
                  <label style={lbl}>วันที่ไลฟ์</label>
                  <input
                    type="date"
                    value={form.live_date}
                    onChange={(e) =>
                      setForm((f) => ({ ...f, live_date: e.target.value }))
                    }
                    style={{
                      ...inp,
                      background: c.subtle,
                ...
                <div>
                  <label style={lbl}>พัก (นาที)</label>
                  <input
                    type="number"
                    min={0}
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, has_clip: e.target.checked }))
                  }
                />
                <label
                  htmlFor="has_clip"
                  style={{ fontSize: 13, fontWeight: 600, color: c.ink2 }}
                >
                  มีคลิปหลังไลฟ์แล้ว
                </label>
              </div>
              <div style={{ display: "grid", gap: 12, marginBottom: 12 }}>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, clip_link: e.target.value }))
                    }
                    placeholder="https://"
                    style={{ ...inp, background: c.subtle }}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f) => ({
                        ...f,
                        live_summary_image: e.target.value,
                      }))
                    }
              ...
              <div>
                <label style={lbl}>Host notes / Feedback</label>
                <textarea
                  value={form.host_notes}
                  onChange={(e) =>
                    setForm((f) => ({ ...f, host_notes: e.target.value }))
                  }
                  rows={3}
                  style={{ ...inp, background: c.subtle, resize: "vertical" }}
                />
              </div>
            </div>
            <div
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button
                onClick={() => setShowCheckoutPanel((v) => !v)}
                style={{
                  padding: "8px 12px",
                  border: `1px solid ${c.border}`,
                  borderRadius: t.radius,
                  background: showCheckoutPanel ? c.accentBg : c.surface,
                  color: showCheckoutPanel ? c.accent : c.ink2,
                  fontSize: 12,
                  fontWeight: 600,
                  cursor: "pointer",
                  display: "inline-flex",
              ...
              >
                <Video size={14} />{" "}
                {showCheckoutPanel ? "ปิดฟอร์ม" : "Log Session"}
              </button>
              <button
                ...
                style={{
                  ...
                  border: "none",
                  borderRadius: t.radius,
                  background: selectedIds.length ? c.pos : c.border,
                  color: selectedIds.length ? "#fff" : c.ink4,
                  fontSize: 12,
                  fontWeight: 700,
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  <th style={opsTh}></th>
                  <th style={opsTh}>Live</th>
                  <th style={opsTh}>เวลา</th>
                  <th style={{ ...opsTh, textAlign: "right" }}>Revenue</th>
                  <th style={opsTh}>Content</th>
                  <th style={opsTh}>Note</th>
                  <th style={opsTh}>Action</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr key={session.id}>
                      <td style={opsTd}>
                        <button
                          ...
                          style={{
                            ...
                            color: selected ? c.accent : c.ink4,
                            cursor: "pointer",
                            padding: 0,
                          }}
                        >
                      ...
                      <td style={opsTd}>
                        <span
                          style={{
                            color: session.has_clip ? c.pos : c.warn,
                            fontWeight: 700,
                          }}
                        >
                      ...
                      <td style={{ ...opsTd, maxWidth: 180, color: c.ink2 }}>
                        {session.host_notes}
                      </td>
                      <td style={opsTd}>
                        <div style={{ display: "flex", gap: 6 }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        padding: "2px 8px",
                        borderRadius: 4,
                        background: STATUS_STYLE[session.status].bg,
                        color: STATUS_STYLE[session.status].color,
                        fontWeight: 600,
                      }}
                    >
                ...
                <tr>
                  {[
                    ...
                    <th
                      ...
                      style={{
                        ...opsTh,
                        textAlign: ["Net", "Revenue"].includes(h)
                          ? "right"
                          : "left",
                      }}
                    >
