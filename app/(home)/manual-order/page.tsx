  ...
  return (
    <div style={{ padding: 24 }}>
                ...
                style={{
                  ...
                  background:
                    activeTab === tab
                      ? "var(--erp-accent)"
                      : "var(--erp-subtle)",
                  color: activeTab === tab ? "#fff" : "var(--erp-ink2)",
                }}
              >
                {tab}
              </button>
            ...
            {filtered.map((o, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    style={{ ...td, fontWeight: 500, color: "var(--erp-ink)" }}
                  >
                    {o.customer}
                  </td>
                  <td
      ...
      <SlidePanel
        ...
        subtitle="บันทึกออร์เดอร์จากช่องทางต่างๆ"
        footer={
      ...
      >
        ...
        >
          <span
            style={{ fontSize: 13, fontWeight: 600, color: "var(--erp-ink)" }}
          >
            รายการสินค้า
          </span>
          <button
            ...
            <tbody>
              {form.lines.map((line, i) => {
                ...
                return (
                  <tr
                    key={i}
                    style={{ borderBottom: "1px solid var(--erp-subtle)" }}
                  >
                    ...
                    >
                      {prod ? formatBaht(prod.price * line.qty) : "—"}
                    </td>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  borderRadius: 7,
                  background: importRows.length
                    ? "var(--erp-accent)"
                    : "#D1D5DB",
                  color: "#fff",
                  cursor: importRows.length ? "pointer" : "not-allowed",
                  fontSize: 13,
                  fontWeight: 600,
                }}
              >
                ยืนยันนำเข้า{" "}
                {importRows.length > 0 ? `(${importRows.length} รายการ)` : ""}
              </button>
            </div>
          </div>
        }
      >
                ...
                <tbody>
                  {importRows.map((row, i) => (
                    ...
                    >
                      ...
                      >
                        {row.amount
                          ? formatBaht(parseFloat(row.amount) || 0)
                          : "—"}
                      </td>
                      <td
                        style={{
        ...
        {!importRows.length && !importError && (
          ...
          >
            <strong>รูปแบบไฟล์ CSV:</strong> customer, phone, channel, amount,
            notes
            <br />
