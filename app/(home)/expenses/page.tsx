  ...
  return (
    <div style={{ minHeight: "100vh", background: c.canvas }}>
      <TopBar
        ...
        right={
          <>
            ...
            <Btn t={t} variant="primary" onClick={() => setOpen(true)}>
              + Record Expense
            </Btn>
          </>
        }
                ...
                >
                  ...
                  >
                    ...
                    >
                      <StatusPill
                        t={t}
                        status={expense.invoiceRef ? "paid" : "pending"}
                      />
                      <button
                        onClick={async () => {
                          ...
                          showToast(
                            `เปลี่ยนสถานะเป็น ${nextInvoiceRef ? "Paid" : "Pending"} แล้ว`,
                          );
                        }}
                        style={{
                          background: "none",
      ...
      <SlidePanel
        ...
        subtitle="เพิ่มรายการค่าใช้จ่ายใหม่"
        footer={
          <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
            ...
            <button
              ...
              disabled={!form.description || !form.amount || !form.vendor}
              style={{
                padding: "9px 20px",
                border: "none",
                borderRadius: 7,
                background:
                  !form.description || !form.amount || !form.vendor
                    ? c.border
                    : c.accent,
                color: "#fff",
                cursor: "pointer",
