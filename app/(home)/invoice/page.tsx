...
export default function InvoicePage() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: c.canvas, width: "100%" }}>
        <TopBar
          ...
          subtitle="ใบแจ้งหนี้"
          right={
            <Btn t={t} variant="accent" onClick={() => setCreateOpen(true)}>
              + สร้างใบแจ้งหนี้
            </Btn>
          }
        />
        <div style={{ padding: "24px 32px 48px" }}>
          <Card t={t} style={{ padding: "48px 24px", textAlign: "center" }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 600, color: c.ink }}>
        ...
        <SlidePanel
          ...
          subtitle="กรอกข้อมูลใบแจ้งหนี้ใหม่"
          footer={
            <div
        ...
        >
          <div style={{ display: "grid", gap: 16 }}>
            ...
            >
              ...
              >
                <option value="">
                  -- เลือก SO หรือสร้าง Manual invoice --
                </option>
                {eligibleSOs.map((so) => (
                  <option key={so.id} value={so.id}>
                    {so.id} — {so.customer} ({fmtBaht(so.amount)})
                  </option>
                ))}
              </select>
            </label>
  ...
  async function handleDownloadPdf() {
    ...
    try {
      ...
      const companyDetails = document.querySelectorAll(
  ...
  const actionRight = (
    ...
    >
      ...
      <Btn t={t} variant="ghost" onClick={() => window.print()}>
        Print
      </Btn>
      <Btn t={t} variant="ghost" onClick={handleDownloadPdf}>
        Download PDF
      </Btn>
      <Btn t={t} variant="ghost">
        Send to customer
      </Btn>
      <Btn t={t} variant="primary" onClick={openPayment}>
        Record payment
      </Btn>
    </div>
  );
        ...
        <div>
            ...
            <Card t={t} pad={false}>
              ...
              >
                <div>
                  ...
                  <div
                    className="print-company-detail"
                    style={{ display: "none" }}
                  >
                    <div
                      style={{
              ...
              {(selected.auditTrail.length
                ...
                >
                  ...
                  <div>
                    ...
                    {event.note && (
                      <div
                        style={{ fontSize: 12, color: c.ink3, marginTop: 2 }}
                      >
                        {event.note}
                      </div>
                    )}
          ...
          <div className="no-print" style={{ marginTop: 24 }}>
            <SectionLabel
              t={t}
              action={
                <Btn t={t} variant="ghost" onClick={() => setCreateOpen(true)}>
                  Create invoice
                </Btn>
              }
            >
        ...
        >
          <Card t={t}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div>
                <Mono t={t} size={26} weight={600} style={{ display: "block" }}>
                  {fmtBaht(outstanding)}
                </Mono>
                <div style={{ fontSize: 11, color: c.ink3, marginTop: 4 }}>
              ...
              <Btn
                ...
                variant="accent"
                onClick={openPayment}
                style={{ padding: "9px 14px", fontSize: 13, marginTop: 4 }}
              >
                Record payment
              </Btn>
            </div>
