...
const td: React.CSSProperties = {
  padding: "11px 14px",
  fontSize: 13,
  borderBottom: "1px solid var(--erp-subtle)",
  verticalAlign: "top",
};
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        >
          {[
            ...
            <div
              key={c.label}
              className="card"
              style={{ padding: "13px 16px", borderRadius: 8 }}
            >
              <div
                style={{
                  fontSize: 11,
              ...
              <div
                style={{ fontSize: 12, color: "var(--erp-ink3)", marginTop: 2 }}
              >
                {c.sub}
              </div>
            </div>
        ...
        {campaigns.length === 0 ? (
          ...
          campaigns.map((c) => {
            ...
            const pct =
              c.targetQty > 0
                ? Math.min(100, Math.round((c.givenQty / c.targetQty) * 100))
                : 0;
            ...
            return (
              ...
              >
                ...
                >
                  <div style={{ flex: 1, minWidth: 200 }}>
                    ...
                    <div style={{ fontSize: 12, color: "var(--erp-ink3)" }}>
                      SKU:{" "}
                      <span
                        style={{ color: "var(--erp-accent)", fontWeight: 600 }}
                      >
                        {c.sku}
                      </span>{" "}
                      · {c.skuName}
                  ...
                  <div style={{ display: "flex", gap: 20, flexShrink: 0 }}>
                    <div style={{ textAlign: "center" }}>
                      ...
                      >
                        {c.givenQty}
                        <span
                          style={{ fontSize: 12, color: "var(--erp-ink3)" }}
                        >
                          /{c.targetQty}
                        </span>
                      </div>
                    ...
                    <div style={{ textAlign: "center" }}>
                      ...
                      >
                        {c.recipients.length > 0
                          ? `${Math.round((convCount / c.recipients.length) * 100)}%`
                          : "—"}
                      </div>
                      <div
                        style={{
                  ...
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    {c.status === "Active" && (
                      <>
                        ...
                        <button
                          onClick={() => {
                            updateSamplingStatus(c.id, "Completed");
                            showToast(`${c.id} → Completed`);
                          }}
                          style={{
                            padding: "6px 12px",
                            fontSize: 12,
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: 11, color: "var(--erp-ink3)" }}>
                      ความคืบหน้า
                    </span>
                    <span
                      style={{
                        fontSize: 11,
                        fontWeight: 700,
                        color: pct >= 100 ? "#059669" : "var(--erp-ink)",
                      }}
                    >
                      {pct}%
                    </span>
                      ...
                      <tbody>
                        {c.recipients.map((r, i) => (
                          ...
                          >
                            ...
                            <td style={{ ...td, color: "var(--erp-ink3)" }}>
                              {r.date}
                            </td>
                            <td
                              style={{
        ...
        <SlidePanel
          ...
          title="สร้างแคมเปญ Sampling"
          subtitle="ติดตามการแจกตัวอย่างสินค้า"
          footer={
            <div
        ...
        >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              type="number"
              min={1}
              value={campaignForm.targetQty || ""}
              onChange={(e) =>
                setCampaignForm((f) => ({
                  ...f,
                  targetQty: parseInt(e.target.value) || 0,
                }))
              }
              placeholder="0"
              style={inp}
          ...
          >
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setCampaignForm((f) => ({ ...f, startDate: e.target.value }))
                }
                style={inp}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setCampaignForm((f) => ({ ...f, endDate: e.target.value }))
                }
                style={inp}
              />
            </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              onChange={(e) =>
                setCampaignForm((f) => ({ ...f, note: e.target.value }))
              }
        ...
        >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              onChange={(e) =>
                setRecipientForm((f) => ({ ...f, contact: e.target.value }))
              }
          ...
          >
            <div>
              ...
              <input
                type="number"
                min={1}
                value={recipientForm.qtyGiven}
                onChange={(e) =>
                  setRecipientForm((f) => ({
                    ...f,
                    qtyGiven: parseInt(e.target.value) || 1,
                  }))
                }
                style={inp}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setRecipientForm((f) => ({ ...f, date: e.target.value }))
                }
                style={inp}
              />
            </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              value={recipientForm.feedback}
              onChange={(e) =>
                setRecipientForm((f) => ({ ...f, feedback: e.target.value }))
              }
          ...
          >
            <input
              type="checkbox"
              id="converted"
              checked={recipientForm.converted}
              onChange={(e) =>
                setRecipientForm((f) => ({ ...f, converted: e.target.checked }))
              }
