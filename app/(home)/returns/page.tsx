...
const BLANK = {
  ...
  sku: "",
  qty: 1,
  condition: "ดี" as ReturnCondition,
  reason: "สินค้าชำรุด" as ReturnReason,
  note: "",
  channel: "Manual",
};
      ...
      <div style={{ padding: "24px 32px 48px" }}>
        ...
        <Card t={t} pad={false} style={{ overflow: "auto" }}>
          <Table className="min-w-[1000px]">
            <TableHeader>
              <TableRow>
                {["RMA", "SO Ref", "Customer", "Channel", "Date", "Reason"].map(
                  (h) => (
                    <TableHead
                      key={h}
              ...
              {rows.map((r) => {
                return (
                  <TableRow key={r.id}>
                    ...
                    <TableCell className="py-3.5 px-6">
                      <span
                        style={{ fontSize: 13, fontWeight: 500, color: c.ink2 }}
                      >
                        {r.channel}
                      </span>
                    </TableCell>
