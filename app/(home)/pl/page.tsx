    ...
    return (
      <tr style={{ background: isHead ? c.subtle : "transparent" }}>
        ...
        >
          ...
          {en && (
            <span style={{ fontSize: 11, color: c.ink3, marginLeft: 8 }}>
              {en}
            </span>
          )}
        </td>
        ...
        >
          {CHANNELS.map((item) => (
            <Btn
              key={item}
              t={t}
              variant={channel === item ? "primary" : "ghost"}
        ...
        >
          {[
            ...
            },
            {
              ...
              sub: `${revCur ? ((grossCur / revCur) * 100).toFixed(1) : "0.0"}% margin`,
            },
            {
              label: "Operating exp.",
              value: opexCur,
            ...
            },
            {
              ...
              primary: true,
              sub: `${revCur ? ((netCur / revCur) * 100).toFixed(1) : "0.0"}% net margin`,
            },
          ].map((item) => (
            <div
              key={item.label}
