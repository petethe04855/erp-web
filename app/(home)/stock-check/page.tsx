    ...
    <div style={{ minHeight: "100vh", background: c.canvas }}>
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        {!counting ? (
                ...
                {products.map((p) => {
                  ...
                  return (
                    <tr key={p.sku}>
                      ...
                      <td
                        style={{ ...td, fontFamily: t.font.mono, fontSize: 11 }}
                      >
                        {p.sku}
                      </td>
                      <td
                      ...
                      <td
                        style={{
                          ...td,
                          color: p.stock <= p.reorder ? c.neg : c.ink3,
          ...
          <div className="card" style={{ overflow: "hidden" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  {["สินค้า", "ยอดระบบ", "ยอดนับจริง", "Variance", "สถานะ"].map(
                    (h) => (
                      <th key={h} style={th}>
                        {h}
                      </th>
                    ...
                    >
                      ...
                      <td style={{ ...td, textAlign: "center" }}>
                        <input
                          ...
                          style={{
                            width: 80,
                            padding: "6px 8px",
                            border: `1px solid ${diff !== 0 ? (diff > 0 ? c.pos : c.neg) : c.border}`,
                            borderRadius: 6,
                            fontSize: 13,
                            textAlign: "center",
                            outline: "none",
                      ...
                      <td
                        style={{
                          ...
                          textAlign: "center",
                          fontWeight: 700,
                          color: diff > 0 ? c.pos : diff < 0 ? c.neg : c.ink3,
                          fontFamily: t.font.mono,
                        }}
                      >
        ...
        <SlidePanel
          ...
          subtitle={`ทั้งหมด ${stockAdjustments.length} รอบ`}
        >
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {adj.date} · {adj.checkedBy} ·{" "}
                        {adj.note || "ไม่มีหมายเหตุ"}
                      </div>
                    </div>
                    <span
                      style={{
                        ...
                        background:
                          varItems.length > 0
                            ? "var(--erp-warnBg, #FEF3C7)"
                            : "var(--erp-posBg, #D1FAE5)",
                        color:
                          varItems.length > 0
                            ? "var(--erp-warn)"
                            : "var(--erp-pos)",
                    ...
                    >
                      {varItems.length > 0
                        ? `มี Variance ${varItems.length} รายการ`
                        : "ไม่มี Variance"}
                    </span>
                    <span style={{ color: "var(--erp-ink3)", fontSize: 14 }}>
                      {isExpanded ? "▲" : "▼"}
                    </span>
                  </div>
                  {isExpanded && (
                    ...
                    >
                      <thead>
                        <tr>
                          {["สินค้า", "ระบบ", "จริง", "Variance"].map((h) => (
                          ...
                          <tr
                            ...
                            style={{
                              background:
                                item.variance !== 0
                                  ? item.variance > 0
                                    ? "var(--erp-posBg, #F0FDF4)"
                                    : "var(--erp-negBg, #FEF2F2)"
                                  : "transparent",
                            }}
                          >
